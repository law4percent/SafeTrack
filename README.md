...
**Screens:**
- **Dashboard** ![Dashboard*](images/dashboard_screen.png) — all linked children, battery, GPS, SOS status
...
|---|---|---|
| ![Dashboard](docs/images/ui_dashboard.png) | ![Live Location](docs/images/ui_live_location.png) | ![My Children](docs/images/ui_my_children.png) |

| Route Registration | Alerts | AI Assistant |
|---|---|---|
| ![Routes](docs/images/ui_route_registration.png) | ![Alerts](docs/images/ui_alerts.png) | ![AI](docs/images/ui_ai_assistant.png) |
